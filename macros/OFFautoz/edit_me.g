...
;set global.clickyoffset = 0.480 ; larger values here means nozzle closer to the bed after autoz ; Textured
set global.clickyoffset = 0.360 ; larger values here means nozzle closer to the bed after autoz ; Satin 3dJAke Nano
;set global.clickyoffset = 0.450 ; larger values here means nozzle closer to the bed after autoz ; PEI
 ;global clickyoffset = 0.450 ; larger values here means nozzle closer to the bed after autoz
