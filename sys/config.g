...
M92 X160.00 Y160.00 Z400.00 E415.00         ; Set steps per mm	1.8 motors							
...
; Motor currents
M906 X1200.00 Y1200.00 Z1100.00 E550.00 I50        ; Set motor currents (mA) and motor idle factor in percent 
...
M143 H0 S115                                                    ; Set temperature limit for heater 0 to 115C Bed


; HotEnd Heaters and Thermistor HotEnd      
M308 S1 P"temp1" Y"thermistor" T100000 B4658 C6.5338987554e-08     	; define E0 temperature sensor slice 300Â°C
...
M106 P3 T50 S235 H1                 ; HOTEND Fan Settings
...
M106 P5 T90 S150 H0                  ; Exhaust fan
